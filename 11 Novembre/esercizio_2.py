# Create un file.txt con uno script python e testo preso da https://it.lipsum.com/, 
# dopoaverlo fatto scrivete un programma che legge il documento e ci restituisce il 
# numero di parole, righe e caratteri.
...
with open("11 Novembre/lorem.txt", "w") as file:

    file.write(testo)

with open("11 Novembre/lorem.txt", "r") as file:
